...
/*#__PURE__*/
function (_Component) {
  _inherits(WithHistoryActions, _Component);

  function WithHistoryActions() {
    var _getPrototypeOf2;

    var _this;

    _classCallCheck(this, WithHistoryActions);
  ...
  return WithHistoryActions;
}(_react.Component);

_defineProperty(WithHistoryActions, "defaultProps", {
  otherProps: {}
});

var mapDispatchToProps = {
  historyPush: _router.historyPush,
  historyPop: _router.historyPop,
  historyReplace: _router.historyReplace
};
var Connected = (0, _reactRedux.connect)(null, mapDispatchToProps)(WithHistoryActions);
